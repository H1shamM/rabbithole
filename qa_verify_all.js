...
(async () => {
  ...
  const stumbleBtnEnabled = await page
    .locator("button.stumble-btn")
    .isEnabled();
  ...
  const resultVisible = await page
    .locator(".iframe-container, .iframe-fallback")
    .first()
    .isVisible();
  ...
  console.log(
    "Note: Step 7 verified via code analysis of dual-layer fallback logic.",
  );
