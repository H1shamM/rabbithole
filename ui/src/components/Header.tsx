...
export function Header({ darkMode, setDarkMode, user, onUserClick, isInstallable, onInstall }: HeaderProps) {
  return (
    <header className="header">
      <div className="header-row">
        ...
        {isInstallable && (
          <button className="btn secondary install-btn" onClick={onInstall} aria-label="Install App">
            📲 Install
          </button>
        )}
      </div>
